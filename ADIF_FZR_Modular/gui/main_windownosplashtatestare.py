...
class ADIFtoPDFApp(ctk.CTk):
    ...
    def crea_interfaccia(self):
        ...
        # ── Orologio doppio: UTC (GMT) + Locale ──
        ctk.CTkFrame(_rin, width=2, height=28, fg_color="#1E3A5F").pack(side="left", padx=(16, 12))
        ...
        self.sb_clock_utc = ctk.CTkLabel(_rin, text="--:--:--",
                                         ...
                                         text_color="#5EEAD4")
        self.sb_clock_utc.pack(side="left")
        ctk.CTkLabel(_rin, text="LOC", font=ctk.CTkFont(size=9, weight="bold"),
                     text_color="#64748B").pack(side="left", padx=(14, 4))
        self.sb_clock_loc = ctk.CTkLabel(_rin, text="--:--:--",
                                         font=ctk.CTkFont(family="Consolas", size=18, weight="bold"),
                                         text_color="#FBBF24")
        self.sb_clock_loc.pack(side="left")
    ...
    def apri_aggiungi_qso(self):
        ...
        cb_banda.grid(row=7, column=0, sticky="w", pady=(0, 10))
        e_freq = ctk.CTkEntry(form, width=140)
        e_freq.grid(row=7, column=1, sticky="w", padx=(8, 0), pady=(0, 10))
        ...
        cb_modo.grid(row=9, column=0, sticky="w", pady=(0, 10))
        e_sat = ctk.CTkEntry(form, width=140, placeholder_text=T("aq_ph_sat"))
        e_sat.grid(row=9, column=1, sticky="w", padx=(8, 0), pady=(0, 10))
        ...
        e_sat_mode = _rxadd(ctk.CTkEntry(form, width=140, placeholder_text="V/U"),
                     row=19, column=0, sticky="w", pady=(0, 10))
        def _mostra_rx(show):
            for _w, _g in _rxw:
                if show:
                    _w.grid(**_g)
        ...
        e_rst_tx.grid(row=12, column=0, sticky="w", pady=(0, 10))
        e_rst_rx = ctk.CTkEntry(form, width=140)
        e_rst_rx.grid(row=12, column=1, sticky="w", padx=(8, 0), pady=(0, 10))
        ...
        e_loc.grid(row=14, column=0, columnspan=2, sticky="w", pady=(0, 14))
        ...
        lk.grid(row=5, column=0, columnspan=2, sticky="w", pady=(0, 10))
    ...
    def apri_preferenze(self):
        ...
        ctk.CTkCheckBox(c2, text=T("pref_ricorda_tema"), variable=var_ricorda_tema,
                        font=ctk.CTkFont(size=11)).pack(anchor="w", pady=(6, 4))
