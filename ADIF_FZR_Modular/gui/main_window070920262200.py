...
class ADIFtoPDFApp(ctk.CTk):
    ...
    def apri_aggiungi_qso(self):
        ...
        qb_side = ctk.CTkFrame(body, fg_color=("#141c25", "#141c25"), corner_radius=8, width=310)
        ...
        qb_head = ctk.CTkFrame(qb_side, fg_color="#1f3a5f", corner_radius=6)
        ...
        ctk.CTkLabel(form, text=T("addqso_locator"), anchor="w",
                     font=ctk.CTkFont(size=11)).grid(row=13, column=0, sticky="w")
        e_loc = ctk.CTkEntry(form, width=290, placeholder_text=T("aq_ph_loc"))
        e_loc.grid(row=14, column=0, columnspan=2, sticky="w", pady=(0, 8))
        ...
        ctk.CTkLabel(lk, text="Lookup:", font=ctk.CTkFont(size=11)).pack(side="left", padx=(0, 6))
        ctk.CTkButton(lk, text=T("ed_lookup_hq"), width=110, height=28, fg_color="#4A5568",
                      command=lambda: _aq_lookup("hamqth")).pack(side="left", padx=(0, 6))
        ctk.CTkButton(lk, text=T("ed_lookup_qrz"), width=90, height=28, fg_color="#4A5568",
